...
- (UIButton*)closeButton{
    ...
    if(!_closeButton){
        ...
        [_closeButton setImage:[UIImage imageNamed:@"preClose"] forState:UIControlStateNormal];
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        [_cameraButton setImage:[UIImage imageNamed:@"preCamer"] forState:UIControlStateNormal];
...
- (UIButton*)beautyButton{
    if(!_beautyButton){
        ...
        [_beautyButton setImage:[UIImage imageNamed:@"preBeauty"] forState:UIControlStateSelected];
        [_beautyButton setImage:[UIImage imageNamed:@"preBeautyNo"] forState:UIControlStateNormal];
...
- (UIButton*)startLiveButton{
    ...
    if(!_startLiveButton){
        ...
        [_startLiveButton setBackgroundColor:[UIColor colorWithRed:51/255.0 green:209/255.0 blue:188/255.0 alpha:1]];
